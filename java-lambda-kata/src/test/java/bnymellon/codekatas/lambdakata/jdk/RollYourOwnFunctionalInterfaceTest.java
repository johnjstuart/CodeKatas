...
public class RollYourOwnFunctionalInterfaceTest
{
    ...
    public void addFourInts()
    {
        ...
        FourIntFunction function = (int a, int b, int c, int d) -> a + b + c + d;
    ...
    private int applyFourIntFunction(int one, int two, int three, int four,
        FourIntFunction function)
    {
        // TODO - Fix this code to call a method on function with the four parameters
        return function.accept(one, two, three, four);
    }
    ...
    public interface FourIntFunction
    {
        ...
        int accept(int one, int two, int three, int four);
    }
}
